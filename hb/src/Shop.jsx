        ...
        <Link>
          ...
          <CarouselProvider
            ...
            <Slider>
              ...
              <Slide index={8}><img className="slider_image" src={image9} /></Slide>
              <Slide index={9}><img className="slider_image" src={image10} /></Slide>
              <Slide index={10}><img className="slider_image" src={image11} /></Slide>
              <Slide index={11}><img className="slider_image" src={image12} /></Slide>
            </Slider>
            ...
            <>
              <div className='shop-container'>
                <div key={item.id} className='item-box'>
                  ...
                  <img className='item-image' alt='shop item image' src={item.images[0]} />
